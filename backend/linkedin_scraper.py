...
class ParsedHtmlScraper:
    ...
    def _setup_driver(self):
        ...
        try:
            ...
            profile_path = r"C:\Users\Nisan Kotik\OneDrive - University of Bath\Year 4\Summer\cred"
    ...
    def run(self):
        ...
        while True:
            ...
            if full_html:
                cleaned_data = self._parse_and_clean_html(full_html)
                print(cleaned_data)

                # Optional: Save to file
                # with open("profile_data.txt", "w", encoding="utf-8") as f:
                #     f.write(cleaned_data)
                # print("Saved to profile_data.txt")
